...
class WPApiAuthenticatorTest extends Orchestra\Testbench\TestCase
{
    ...
    public function testMakeRequest()
    {
        ...
        $authenticator = new WPApiAuthenticator($this->guzzleClient);

        $response = $authenticator->requestUserByToken($token);
